      ...
      <div className="container">
        ...
        <div className="projects-gallery">
          {filteredProjects.map((project, index) => (
            <div key={index} className="gallery-item" data-category={project.category}>
                  ...
                  <div className="gallery-content">
                    ...
                    <div className="gallery-links">
                      {project.demoLink === 'multiple' ? (
                        <button onClick={(e) => showDemoOptions(project.demoOptions, e)} className="gallery-btn demo-btn" style={{border: 'none', background: 'transparent', color: 'inherit', font: 'inherit', cursor: 'pointer'}}>
                          <i className="fas fa-eye"></i> View Demo
                        </button>
                      ) : project.title === 'App Store Analysis' ? (
                        <button onClick={(e) => handleExternalDemo(project.demoLink, e)} className="gallery-btn demo-btn" style={{border: 'none', background: 'transparent', color: 'inherit', font: 'inherit', cursor: 'pointer'}}>
                          <i className="fas fa-eye"></i> View Demo
                        </button>
                      ) : (
                        <a href={project.demoLink} className="gallery-btn demo-btn" target="_blank" rel="noopener noreferrer">
                          <i className="fas fa-eye"></i> View Demo
                        </a>
                      )}
                      <button onClick={showCodeProtectionMessage} className="gallery-btn code-btn" style={{border: 'none', background: 'transparent', color: 'inherit', font: 'inherit', cursor: 'pointer'}}>
